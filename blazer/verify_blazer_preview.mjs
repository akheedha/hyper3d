...
<head>
  ...
  <title>TC Blazer 3D SDF Preview</title>
  <style>
...
<body>
  <div id="controls">
    <div style="font-weight:700;font-size:14px;margin-bottom:12px;color:#111;">Blazer 3D Controls</div>
  ...
  <script>
    ...
    const texturePath = "blazer_sdf_128_atlas.png";
